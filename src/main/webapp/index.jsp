...
<head>
    ...
    <link rel="stylesheet" href="${contextroot}/webjars/codemirror/5.24.2/lib/codemirror.css" />
    <script src="${contextroot}/webjars/codemirror/5.24.2/lib/codemirror.js"></script>
